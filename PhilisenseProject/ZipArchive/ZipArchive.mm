...
//	NSDictionary* attr = [fileManager fileAttributesAtPath:file traverseLink:YES];
    NSDictionary* attr = [fileManager attributesOfItemAtPath:file error:nil];
	if( attr )
	{
